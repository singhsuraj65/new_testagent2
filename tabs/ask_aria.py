...
def render():
    # Force centering for this tab only using a dedicated container
    st.markdown(
        """
        <style>
        /* Override global main container for this page */
        ...
        /* Ensure chat messages are not too wide */
        .stChatMessage {
            max-width: 80% !important;
        }
        /* Center chat input widget */
        .stChatInput {
            max-width: 800px !important;
            margin: 0 auto !important;
        }
        /* Optional: make the header text look nice */
        .chat-header {
            text-align: center;
            margin-bottom: 1rem;
        }
