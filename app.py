...
/* ── MAIN CONTENT AREA ─────────────────────────────────────────────────────── */
/* FIX 1: Was padding:0!important which wiped all spacing.
   Now we keep top:0 but add generous left/right padding. */
.block-container{
...
/* ── SIDEBAR ───────────────────────────────────────────────────────────────── */
/* FIX 2: Was 220px — increased to 270px for more breathing room */
...
/* FIX 3: Was padding:0!important — now gives sidebar content proper inner spacing */
...
section[data-testid="stSidebar"] .stTextInput>div>div{
    background:rgba(244,123,37,0.04)!important;
...
# # selected = option_menu(
# #     menu_title=None,
# #     options=["Command Center", "Material Intelligence", "Risk Radar", "Scenario Engine", "Supply Network", "Ask ARIA"],   # added "Ask ARIA"
# #     icons=["grid", "search", "broadcast", "lightning", "diagram-3", "chat-dots"],   # added chat icon
# #     orientation="horizontal",
# #     styles={
# #         "container":       {"padding": "5px 20px", "background-color": "#FFFFFF", "border-bottom": "1px solid #E2E8F0"},
# #         "nav-link":        {"font-family": "Inter", "font-size": "12px", "font-weight": "500", "color": "#475569",
...
# # elif selected == "Scenario Engine":       tab_se.render()
# # elif selected == "Supply Network":        tab_sn.render()
# # elif selected == "Ask ARIA":              tab_aa.render()   # NEW
